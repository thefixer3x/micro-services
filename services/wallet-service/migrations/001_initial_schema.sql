...
-- Version: 001
-- Description: Create initial tables for wallets, transactions, cards, and customers
...
CREATE INDEX idx_customers_provider ON customers(provider, provider_customer_id);
CREATE INDEX idx_customers_email ON customers(email);
CREATE INDEX idx_wallets_customer_id ON wallets(customer_id);
CREATE INDEX idx_wallets_provider ON wallets(provider, provider_wallet_id);
CREATE INDEX idx_wallets_status ON wallets(status);
CREATE INDEX idx_transactions_wallet_id ON transactions(source_wallet_id);
