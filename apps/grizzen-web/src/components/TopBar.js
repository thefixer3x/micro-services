...
const TopBar = () => {
  ...
  return (
    <div>
       <Navbar expand="lg" className="navbar shadow-sm" style={{position: "fixed"}}>
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto text-center d-flex justify-content-center align-items-center">
              <Nav.Link href="#hero" className='navbar-link'>Home</Nav.Link>
              <Nav.Link href="#features" className='navbar-link'>Features</Nav.Link>
              <Nav.Link href="#testimonial" className='navbar-link'>Testimonials</Nav.Link>
              <Nav.Link href="#how" className='navbar-link'>How it works</Nav.Link>
              <Nav.Link href="#" className='navbar-link text-decoration-none border-0'>
                <div className="buttons">
                  <Button size="sm" className="login text-decoration-none border-0">login</Button>
                  <Button size="sm" className="register text-decoration-none border-0">Sign up</Button>
                </div>
              </Nav.Link>
